...
Declare Sub NewWindow(hName As String, x As Integer, y As Integer, w As Integer, h As Integer, title As String, c As ULong)
Declare Sub WatchWindows()


Type hWindow Extends hControl '...'
    ...
    Declare Constructor()
    Declare Constructor(As String, As Integer, As Integer, As Integer, As Integer, As Integer, As String, As ULong)
    Declare Sub redraw()
...
Constructor hWindow(hName As String, id As Integer, x As Integer, y As Integer, w As Integer, h As Integer, t As String, c As ULong) '...'
  This.hName = hName
  This.id = id
  This.x = x
  This.y = y
...
Sub NewWindow(hName As String, x As Integer, y As Integer, w As Integer, h As Integer, title As String, c As ULong) '...'
	'new window
	iWindowPopulation += 1
	ReDim Preserve pWindows(1 To iWindowPopulation)
	pWindows(iWindowPopulation) = New hWindow(hName, iWindowPopulation, x, y, w, h, title, c)
End Sub
